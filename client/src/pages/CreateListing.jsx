  ...
  const handleSubmit= async(e)=>{
    ...
    try {
      ...
      if (+formData.regularPrice < +formData.discountPrice ) {
        return setError('Discount price cannot be lower than regular price')
      }
      setLoading(true)
      setError(false)
      ...
      <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
        ...
        <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="flex gap-4">  
              ...
              />
              <button   disabled={uploading} type='button' onClick={handleImageSubmit} className="text-green-700  p-3 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">
